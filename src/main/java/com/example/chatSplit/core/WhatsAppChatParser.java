...
public class WhatsAppChatParser {
     ...
     */
    private static final String DATE_PATTERN = "dd/MM/yyyy, h:mm a";
     ...
     */
    private static Message buildMessage(String rawLine, Map<String, MediaEntry> mediaFiles, ZipFile zipFile) {
     ...
     */
    private static Type classifyMessage(String content) {
